...
delta_t = 0.001  # Incremento por cada frame
animacion = False  
...
# COMIENZO DE LOSA DEPORTIVA
    ...
    if area_administrativa:
        draw_animated_line((0.0, 1.0, 1.0), puerta_upn, (-34.9, 5.5, -15.0), animaciones["area_administrativa"]["t"])
        draw_animated_line((0.0, 1.0, 1.0), (-35.0, 5.7, -50.0), (-35.0, 5.5, -15.0), animaciones["area_administrativa"]["t"])

    if pabellon_a:
        draw_animated_line((1.0, 1.0, 0.0), puerta_upn, (-15.0, 5.5, -15.0), animaciones["pabellon_a"]["t"])
        draw_animated_line((1.0, 1.0, 0.0), (-25.0, 5.7, -30.0), (-15.0, 5.7, -30.0), animaciones["pabellon_a"]["t"])
        draw_animated_line((1.0, 1.0, 0.0), (-15.0, 5.7, -30.0), (-15.0, 5.5, -15.0), animaciones["pabellon_a"]["t"])

    if area_verde:
        draw_animated_line((0.0, 1.0, 0.0), puerta_upn, (7.0, 5.5, -15.0), animaciones["area_verde"]["t"])
        draw_animated_line((0.0, 1.0, 0.0), (7.0, 5.7, -39.0), (7.0, 5.5, -15.0), animaciones["area_verde"]["t"])

    if cafetin:
        draw_animated_line((1.0, 1.0, 0.0), puerta_upn, (25.0, 5.5, -15.0), animaciones["cafetin"]["t"])
        draw_animated_line((1.0, 1.0, 0.0), (25.0, 5.7, -39.0), (25.0, 5.5, -15.0), animaciones["cafetin"]["t"])
        draw_animated_line((1.0, 1.0, 0.0), (35.0, 5.7, -39.0), (25.0, 5.7, -39.0), animaciones["cafetin"]["t"])

    if pabellon_b:
        draw_animated_line((0.0, 1.0, 0.0), puerta_upn, (25.0, 5.5, -15.0), animaciones["pabellon_b"]["t"])
        draw_animated_line((0.0, 1.0, 0.0), (25.0, 5.7, -30.0), (25.0, 5.5, -15.0), animaciones["pabellon_b"]["t"])
        draw_animated_line((0.0, 1.0, 0.0), (35.0, 5.7, -30.0), (25.0, 5.7, -30.0), animaciones["pabellon_b"]["t"])

    if biblioteca:
        draw_animated_line((0.0, 1.0, 1.0), puerta_upn, (38.0, 5.5, -15.0), animaciones["biblioteca"]["t"])
        draw_animated_line((0.0, 1.0, 1.0), (38.0, 5.7, -39.0), (38.0, 5.5, -15.0), animaciones["biblioteca"]["t"])

    if losa_deportiva:
        draw_animated_line((0.0, 1.0, 1.0), puerta_upn, (59.0, 5.5, -15.0), animaciones["losa_deportiva"]["t"])
        draw_animated_line((0.0, 1.0, 1.0), (59.0, 5.7, -35.0), (59.0, 5.5, -15.0), animaciones["losa_deportiva"]["t"])
...
def keyboard(key, x, y):
    ...
    if key == b'1': 
        ...
        start_animation('area_administrativa') 
        glutPostRedisplay()  

    if key == b'2':  
        pabellon_a = not pabellon_a 
        start_animation('pabellon_a') 
        glutPostRedisplay()  

    if key == b'3': 
        area_verde = not area_verde  
        start_animation('area_verde') 
        glutPostRedisplay()  

    if key == b'4':  
        pabellon_b = not pabellon_b  
        start_animation('pabellon_b') 
        glutPostRedisplay() 
    
    if key == b'5':  
        cafetin = not cafetin 
        start_animation('cafetin')  
        glutPostRedisplay()

    if key == b'6':  
        biblioteca = not biblioteca
        start_animation('biblioteca')   
        glutPostRedisplay()

    if key == b'7':  
        losa_deportiva = not losa_deportiva  
        start_animation('losa_deportiva') 
        glutPostRedisplay()
